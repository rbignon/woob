...
class FunmoocBrowser(LoginBrowser):
    ...
    course = URL(
        "/courses/(?P<course>[^/]+/[^/]+/[^/]+)/courseware/?$",
        "/courses/(?P<course>[^/]+/[^/]+/[^/]+)/info/?$",
        PageChapter,
    )
    chapter = URL("/courses/(?P<course>[^/]+/[^/]+/[^/]+)/courseware" "/(?P<chapter>[0-9a-f]+)/$", PageChapter)
    section = URL(
        "/courses/(?P<course>[^/]+/[^/]+/[^/]+)/courseware/" "(?P<chapter>[0-9a-f]+)/(?P<section>[0-9a-f]+)/$",
        PageSection,
    )
