...
class HTMLErrorPage(HTMLPage):
    ...
    def get_error(self):
        ...
        return CleanText('//b[has-class("x-attentionErreurLigneHaut")]')(self.doc) or CleanText(
            '//div[has-class("x-attentionErreur")]/b'
        )(self.doc)
...
class ProfilePage(JsonLoggedBasePage):
    ...
    def get_profile(self):
        ...
        profile.name = CleanText(
            Format("%s %s", CleanText(Dict("donnees/nom")), CleanText(Dict("donnees/prenom"), default=""))
        )(self.doc)
...
class AccountItemElement(ItemElement):
    ...
    def obj_type(self):
        ...
        if extended_type != "UNKNOWN":
            type_ = Map(CleanText(Dict("bankAccountTypeExtended")), ACCOUNT_EXTENDED_TYPES, type_)(self)
        return type_
...
class HistoryPage(JsonLoggedBasePage):
    ...
    class iter_history(DictElement):
        ...
        class item(ItemElement):
            ...
            def obj_type(self):
                if Env("account_type")(self) == Account.TYPE_CARD and self.obj.type == Transaction.TYPE_CARD:
