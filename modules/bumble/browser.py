...
class BumbleBrowser(StatesMixin, APIBrowser):
    ...
    def do_login(self):
        ...
        if not pincode:
            ...
            self.update_session()
            raise SentOTPQuestion("pincode", medium_type=OTPSentType.SMS, message="Enter the PIN code")
        else:
            ...
            "body": [
                {
                    ...
                    "server_app_startup": {
                        ...
                        "supported_notifications": [83, 73, 3, 72, 49, 46, 109, 81, 44, 96, 89],
                        "supported_payment_providers": [26, 100, 35, 100001, 191],
                        "supported_promo_blocks": [
                            {"context": 92, "position": 13, "types": [71]},
                            {"context": 45, "position": 21, "types": [148]},
                            {"context": 89, "position": 5, "types": [160, 358]},
                            {"context": 8, "position": 13, "types": [111, 112, 113]},
                            {"context": 53, "position": 18, "types": [136, 93, 12]},
                            {"context": 45, "position": 18, "types": [327]},
                            {
                                "context": 45,
                                "position": 15,
                                "types": [410, 93, 134, 135, 136, 137, 327, 308, 309, 334, 187, 61, 422, 423],
                            },
                            {"context": 10, "position": 1, "types": [265, 266, 286]},
                            {"context": 148, "position": 21, "types": [179, 180, 283]},
                            {"context": 26, "position": 13, "types": [354]},
                            {"context": 26, "position": 4, "types": [355, 356]},
                            {"context": 26, "position": 1, "types": [354]},
                            {"context": 26, "position": 18, "types": [357]},
                            {"context": 130, "position": 13, "types": [268, 267]},
                            {"context": 113, "position": 1, "types": [228]},
                            {"context": 3, "position": 1, "types": [80, 423]},
                            {"context": 3, "position": 4, "types": [80, 228, 423]},
                            {"context": 119, "position": 1, "types": [80, 282, 81, 90, 422, 140]},
                            {"context": 43, "position": 1, "types": [96, 307]},
                            {"context": 43, "position": 18, "types": [369]},
                            {"context": 119, "position": 18, "types": [369]},
                            {"context": 10, "position": 18, "types": [358, 174]},
                            {"context": 10, "position": 8, "types": [358]},
                            {"context": 26, "position": 16, "types": [286, 371]},
                            {"context": 10, "position": 6, "types": [286, 373, 372]},
                            {"context": 246, "position": 13, "types": [404]},
                        ],
                        "supported_user_substitutes": [{"context": 1, "types": [3]}],
                        "supported_onboarding_types": [9],
                        "user_field_filter_client_login_success": {
                            "projection": [210, 220, 230, 200, 91, 890, 340, 10, 11, 231, 71, 93, 100]
                        },
                        "a_b_testing_settings": {"tests": [{"test_id": "bumble__gifs_with_old_input"}]},
                        "dev_features": [
                            "bumble_bizz",
                            "bumble_snooze",
                            "bumble_questions",
                        ...
                        "supported_landings": [{"source": 25, "params": [20, 3], "search_settings_types": [3]}],
    ...
    def update_session(self):
        data = {
            ...
            "body": [
                {
                    "message_type": 199,
                    "server_update_session": {"hotpanel_session_id": "1c8ca36d-2634-4fc2-bb87-634778f6902b"},
                }
            ],
            "message_id": 7,
            "message_type": 199,
    ...
    def validate_phone(self):
        data = {
            ...
            "body": [
                {
                    "message_type": 640,
                    "server_validate_phone_number": {"phone_prefix": "+33", "phone": self.phone, "context": 203},
                }
            ],
            "message_id": 9,
            "message_type": 640,
    ...
    def check_phone_pin(self, pin_code):
        data = {
            "$gpb": "badoo.bma.BadooMessage",
            "body": [
                {"message_type": 680, "server_check_phone_pin": {"pin": pin_code, "screen_context": {"screen": 25}}}
            ],
            "message_id": 23,
            "message_type": 680,
            "version": 1,
            ...
            "body": [
                {
                    ...
                    "server_get_user": {
                        ...
                        "user_field_filter": {
                            ...
                            "request_albums": [
                                {"person_id": user_id, "album_type": 2, "offset": 1},
                                {"person_id": user_id, "album_type": 12, "external_provider": 12},
                            ],
                        },
                        "client_source": 10,
                    },
