...
from woob.browser.filters.standard import CleanText, Date, Regexp, Type
from woob.browser.pages import HTMLPage
from woob.capabilities.base import NotAvailable
from woob.capabilities.torrent import MagnetOnly, Torrent
...
class TorrentPage(HTMLPage):
    ...
    class get_torrent(ItemElement):
        ...
        obj_size = CleanText('//div[@class="files"]/div/@title', replace=[(",", ""), ("b", "")]) & Type(type=float)
        ...
        def obj_url(self):
            return self.page.browser.BASEURL + Regexp(
                CleanText('//div[@class="trackers"]/h2'), r"hash ([0-9a-f]+)", "\\1"
            )(self)
