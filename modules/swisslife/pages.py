...
class BankAccountDetailPage(LoggedPage, JsonPage):
    ...
    class iter_investment(DictElement):
        ...
        class item(ItemElement):
            ...
            obj_label = Coalesce(
                Regexp(CleanText(Dict("libelle")), r"(.*) \(", default=None), CleanText(Dict("libelle"))
            )
    ...
    class iter_history(DictElement):
        ...
        class item(ItemElement):
            ...
            def obj_type(self):
                ...
                account_type = MapIn(
                    Lower(Field("label"), transliterate=True), self.TRANSACTION_TYPES, default=Transaction.TYPE_UNKNOWN
                )(self)
            ...
            def obj_investments(self):
                ...
                inv.label = Regexp(CleanText(Dict("instrumentFinancier")), r"(.*) \(", default=None)(self) or CleanText(
                    Dict("instrumentFinancier")
                )(self)
                inv.code = IsinCode(
                    Regexp(CleanText(Dict("instrumentFinancier")), r".* \((.*)\)", default=""), default=NotAvailable
                )(self)
                inv.code_type = IsinType(
                    Regexp(CleanText(Dict("instrumentFinancier")), r".* \((.*)\)", default=""), default=NotAvailable
                )(self)
