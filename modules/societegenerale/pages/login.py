...
class LoginPage(JsonPage):
    ...
    def get_skippable_action_needed(self):
        if Dict("commun/statut", default="")(self.doc).lower() == "ok" and Dict("commun/raison", default=None)(
            self.doc
        ):
            return Dict("commun/raison")(self.doc)
...
class ErrorPage(HTMLPage):
    def on_load(self):
        message = CleanText('//span[contains(text(), "Une erreur est survenue lors du chargement de la page")]')(
            self.doc
        )
