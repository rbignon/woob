...
class RecipientsJsonPage(LoggedDetectionMixin, ErrorCheckedJsonPage):
    ...
    def is_all_external_recipient(self):
        return Dict("donnees/nbTotalDestinataires")(self.doc) == len(self.doc["donnees"]["items"]) and not Dict(
            "donnees/moreItems"
        )(self.doc)
        ...
        class Item(ItemElement):
            ...
            def obj_balance(self):
                return eval_decimal_amount(
                    "soldeComptableVeille/valeurMontant", "soldeComptableVeille/codeDecimalisation"
                )(self.data)
