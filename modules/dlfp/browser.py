...
class DLFP(LoginBrowser):
    ...
    wiki_edit = URL(r"/wiki$", r"/wiki/nouveau", r"/wiki/[^\.]+/modifier", WikiEditPage)
    ...
    def board_post(self, msg):
        self.open(self.absurl("/board/"), data={"board[message]": msg}, headers={"Referer": self.absurl("/")})
