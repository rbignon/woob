...
class PoleEmploiBrowser(PagesBrowser):
    ...
    search = URL(r"/offres/recherche\?(?P<param>.*?)", r"/offres/recherche\?motsCles=(?P<pattern>.*?)", SearchPage)
    ...
    def advanced_search_job(
        self, metier="", place=None, contrat=None, salary=None, qualification=None, limit_date=None, domain=None
    ):
