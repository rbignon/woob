...
class SearchResultsPage(HTMLPage):
    def __init__(self, *args, **kwargs):
        ...
        json_content = Regexp(
            CleanText("//script"), r"window\[\"initialData\"\] = JSON.parse\(\"({.*})\"\);window\[\"tags\"\]"
        )(self.doc)
        ...
        class item(ItemElement):
            ...
            def condition(self):
                return (
                    ...
                    and (
                        Dict("classifiedURL", default="")(self).startswith(BASE_URL)
                        or int(Env("query_type")(self)) == TYPES[POSTS_TYPES.RENT]
                    )
                )
            ...
            def obj_title(self):
                return "{} - {} - {}".format(
                    Dict("estateType")(self), " / ".join(Dict("tags")(self)), Field("location")(self)
                )
...
class HousingPage(HTMLPage):
    ...
    class get_housing(ItemElement):
        ...
        def obj_utilities(self):
            mention = Dict(
                "props/pageProps/listingData/listing/listingDetail/listingPrice/price/priceInformation", default=""
            )(self)
        ...
        obj_bedrooms = CleanDecimal(
            Dict("props/pageProps/listingData/listing/listingDetail/bedroomCount"), default=NotAvailable
        )
        obj_rooms = CleanDecimal(
            Dict("props/pageProps/listingData/listing/listingDetail/roomCount"), default=NotAvailable
        )
        ...
        def obj_GES(self):
            ges = Dict(
                "props/pageProps/listingData/listing/listingDetail/energyPerformanceCertificate/gasRating", default=None
            )(self)
            if ges is not None:
