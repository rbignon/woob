...
class FonciaItemElement(ItemElement):
    ...
    def obj_cost(self):
        if Field("type")(self) == POSTS_TYPES.SALE:
            ...
            return CleanDecimal(Dict("loyer"))(self) + CleanDecimal(Dict("loyerAnnexe", default=0))(self)
    ...
    obj_title = Format(
        r"%s %s - %sm²", Dict("typeBien"), Dict("localisation/locality/libelleDisplay"), Format("%.2f", Field("area"))
    )
