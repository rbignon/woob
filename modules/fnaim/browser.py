...
class FnaimBrowser(PagesBrowser):
    ...
    search = URL(
        "/include/ajax/annonce/ajax.annonceList.php", r"/18-location.htm\?.*", r"/17-acheter.htm\?.*", SearchPage
    )
    ...
    def search_housings(self, query):
        ...
        data = "&".join(
            [transaction, localities, types_search, nb_pieces, surfaces, prix, nb_chambres, terrain, meuble, op]
        )
