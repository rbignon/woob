...
from .pages import (
    ...
    InfoPage, LoginPage, ConnexionPage,
)
...
class ApivieBrowser(TwoFactorBrowser):
    connexion = URL(r'https://front-client.intencial.fr/connexion', ConnexionPage)
        ...
        try:
            ...
            if e.response.status_code == 400:
                ...
                if 'Code de sécurité à saisir' in error_message:
                    # if we are here ths sms is already sent to the PSU
