...
class AccountsPage(LoggedPage, HTMLPage):
    ...
    class iter_accounts(TableElement):
        ...
        item_xpath = (
            '//table[contains(@class,"tableau_comptes_details")]//tr[not(ancestor::thead) and not(ancestor::tfoot)]'
        )
...
class InvestmentsPage(LoggedPage, HTMLPage):
    ...
    class get_investments(TableElement):
        ...
        class item(ItemElement):
            ...
            def obj_unitprice(self):
                ...
                return CleanDecimal.French(
                    Regexp(CleanText(TableCell("unitprice")), r"(.*)(?:\(.*\))?", default=NotAvailable),
                    default=NotAvailable,
                )(self)
    ...
    def get_liquidity(self):
        ...
        liquidity_element = CleanDecimal.French(
            '//td[contains(text(), "Solde espèces en euros")]//following-sibling::td[position()=1]', default=None
        )(self.doc)
...
class MarketOrdersPage(LoggedPage, HTMLPage):
    ...
    class iter_market_orders(TableElement):
        ...
        class item(ItemElement):
            ...
            obj_code = IsinCode(
                Regexp(Base(TableCell("label"), CleanText(".//a/@href")), r"Quote\('([^']*)'", default=NotAvailable),
                default=NotAvailable,
            )
    ...
    class fill_market_order(ItemElement):
        ...
        obj_amount = CleanDecimal.French(
            '//td[contains(text(), "Total")]/following-sibling::td[1]', default=NotAvailable
        )
