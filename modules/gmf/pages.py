    ...
    class iter_history(ListElement):
        ...
        class item(ItemElement):
            ...
            obj__detail_id = Regexp(
                Attr("./td[4]/a", "href", default=NotAvailable), r"popin(\d+)", default=NotAvailable
            )
            ...
            class get_investments(InvestmentsParser):
                ...
                col_quantity = re.compile(
                    "Nombre"
                )  # use regex because the column name tends to be inconsistent between the tables
    ...
    def show_all_transactions(self):
        ...
        if self.doc.xpath('//span[contains(text(), "Plus de mouvements financiers")]'):
            try:
                ...
                form["javax.faces.partial.render"] = (
                    "formStep1:tabOnglets:listeMouvements formStep1:tabOnglets:gPlusDeMouvementFinancier formStep1:tabOnglets:gMoinsDeMouvementFinancier formStep1:tabOnglets:listPopinMouvement"
                )
