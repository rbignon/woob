...
SENSOR_TYPES = OrderedDict(
    [("available_bikes", "Available bikes"), ("available_bike_stands", "Free stands"), ("bike_stands", "Total stands")]
)
...
class jcvelauxModule(Module, CapGauge):
    ...
    CONFIG = BackendConfig(
        Value("city", label="City", default="Lyon", choices=CITIES + ("ALL",)),
