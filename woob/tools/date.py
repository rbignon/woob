...
DATE_TRANSLATE_FR = [(re.compile('janvier', re.I),   'january'),
                     (re.compile('f[eé]vrier', re.I | re.U),   'february'),
                     (re.compile('mars', re.I),      'march'),
                     (re.compile('avril', re.I),     'april'),
                     (re.compile('mai', re.I),       'may'),
                     (re.compile('juin', re.I),      'june'),
                     (re.compile('juillet', re.I),   'july'),
                     (re.compile('ao[uû]t?', re.I | re.U),  'august'),
                     (re.compile('septembre', re.I), 'september'),
                     (re.compile('octobre', re.I),   'october'),
                     (re.compile('novembre', re.I),  'november'),
                     (re.compile('d[eé]cembre', re.I | re.U),'december'),
                     (re.compile('jan\\.', re.I),    'january'),
                     (re.compile('janv\\.', re.I),   'january'),
                     (re.compile('\\bjan\\b', re.I), 'january'),
                     (re.compile('f[eé]v\\.', re.I | re.U),    'february'),
                     (re.compile('f[eé]vr\\.', re.I | re.U),   'february'),
                     (re.compile('\\bf[eé]v\\b', re.I | re.U), 'february'),
                     (re.compile('\\bf[eé]vr\\b', re.I | re.U), 'february'),
                     (re.compile('avr\\.', re.I),    'april'),
                     (re.compile('\\bavr\\b', re.I), 'april'),
                     (re.compile('juil\\.', re.I),   'july'),
                     (re.compile('juill\\.', re.I),  'july'),
                     (re.compile('\\bjuil\\b', re.I),'july'),
                     (re.compile('sep\\.', re.I),    'september'),
                     (re.compile('sept\\.', re.I),   'september'),
                     (re.compile('\\bsep\\b', re.I), 'september'),
                     (re.compile('oct\\.', re.I),    'october'),
                     (re.compile('\\boct\\b', re.I), 'october'),
                     (re.compile('nov\.', re.I),     'november'),
                     (re.compile('\\bnov\\b', re.I), 'november'),
                     (re.compile('d[eé]c\\.', re.I | re.U), 'december'),
                     (re.compile('\\bd[eé]c\\b', re.I | re.U), 'december'),
                     (re.compile('lundi', re.I),     'monday'),
                     (re.compile('mardi', re.I),     'tuesday'),
                     (re.compile('mercredi', re.I),  'wednesday'),
                     (re.compile('jeudi', re.I),     'thursday'),
                     (re.compile('vendredi', re.I),  'friday'),
                     (re.compile('samedi', re.I),    'saturday'),
                     (re.compile('dimanche', re.I),  'sunday')]
